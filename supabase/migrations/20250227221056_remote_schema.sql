...
COMMENT ON TABLE "public"."activities" IS 'A list of all the CQC activities that need to be periodically completed';
...
ALTER TABLE ONLY "public"."activities"
    ADD CONSTRAINT "activities_id_key" UNIQUE ("id");
